...
def compute_payslip(
    *,
    ...
    union_dues_deduction_minor: int = 0,
) -> PayslipComputation:
    ...
    if union_dues_deduction_minor < 0:
        raise ValueError("union_dues_deduction_minor must not be negative")
    ...
    net_pay_before_loan_minor = gross_minor - pension_employee_minor - nhf_minor - paye_minor
    if net_pay_before_loan_minor < 0:
    ...
    net_pay_before_union_dues_minor = net_pay_before_benefits_minor - benefit_deduction_minor
    if union_dues_deduction_minor > net_pay_before_union_dues_minor:
        raise ValueError("union_dues_deduction_minor exceeds net pay after the benefit deduction")
    net_pay_minor = net_pay_before_union_dues_minor - union_dues_deduction_minor
    ...
    return PayslipComputation(
        ...
        union_dues_deduction_minor=union_dues_deduction_minor,
